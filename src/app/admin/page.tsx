        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-[#1F4E79] rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div>
                <h1 className="text-2xl font-bold text-[#1C1C1C]">Admin Dashboard</h1>
                <p className="text-sm text-[#555555]">Integrated Value Solutions</p>
              </div>
            </div>
            <button
              onClick={() => {
              ...
              className="flex items-center px-4 py-2 text-sm font-medium text-[#1F4E79] bg-[#1F4E79]/10 rounded-lg hover:bg-[#1F4E79]/20 transition-colors"
            >
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#1F4E79]/10 rounded-lg flex items-center justify-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-[#555555]">Total Contacts</p>
                  <p className="text-2xl font-bold text-[#1C1C1C]">{stats.totalContacts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-[#555555]">New</p>
                  <p className="text-2xl font-bold text-red-600">{stats.newContacts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-[#555555]">Contacted</p>
                  <p className="text-2xl font-bold text-yellow-600">{stats.contactedContacts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-[#555555]">Closed</p>
                  <p className="text-2xl font-bold text-green-600">{stats.closedContacts}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold text-[#1C1C1C]">Contact Submissions</h2>
                          ...
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                <h3 className="text-sm font-semibold text-[#1C1C1C]">{contact.name}</h3>
                                <span className="text-xs">{getStatusIcon(contact.status)}</span>
                              </div>
                              <p className="text-sm text-[#555555]">{contact.email}</p>
                              <p className="text-xs text-[#F47A21] font-medium">{contact.service}</p>
                  ...
                  {selectedContact ? (
                    <div className="bg-white border border-gray-200 rounded-lg">
                      <div className="p-4 border-b border-gray-200">
                        <h3 className="text-lg font-semibold text-[#1C1C1C]">Contact Details</h3>
                      </div>
            ...
            {activeTab === 'templates' && (
              <div>
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-lg font-semibold text-[#1C1C1C]">Email Templates</h2>
                  <button
                    onClick={() => setShowEmailModal(true)}
                    className="bg-[#1F4E79] text-white px-4 py-2 rounded-lg hover:bg-[#1a4268] transition-colors flex items-center"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {emailTemplates.map((template) => (
                    <div key={template.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-[#1C1C1C]">{template.name}</h3>
                          <p className="text-sm text-[#555555]">{template.type.replace('_', ' ').toUpperCase()}</p>
                        </div>
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="flex-1 bg-[#1F4E79] text-white px-3 py-2 rounded text-sm hover:bg-[#1a4268] transition-colors"
                        >
                          Edit
                        </button>
                        <button
                        ...
                        <button
                          ...
                          className="flex-1 border border-[#F47A21] text-[#F47A21] px-3 py-2 rounded text-sm hover:bg-[#F47A21]/10 transition-colors"
                        >
                          Preview
                        </button>
                      </div>
